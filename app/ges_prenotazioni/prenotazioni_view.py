...
class PrenotazioniView(Ui_Prenotazioni, QWidget):
    def __init__(self, model: PrenotazioniModel, controller: PrenotazioniController, parent=None):
    ...
    def closeEvent(self, event: QCloseEvent):
        ...
        Ambiente.stati[App.PRENOTAZIONI.value] = Stati.CHIUSO
        event.accept()
        # prevedere la non accettazione della chiusura per modifiche non salvate

    def modificato(self):
        Ambiente.stati[App.PRENOTAZIONI.value] = Stati.MODIFICATO
    ...
    def annulla(self):
        ...
        if Ambiente.stati[App.PRENOTAZIONI.value] == Stati.MODIFICATO:
